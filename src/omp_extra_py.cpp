...
void init_omp_extra(py::module &m) {
  ...
  // m.def("set_default_allocator", &omp_set_default_allocator); // gives not
  // delcared error m.def("get_default_allocator", &omp_get_default_allocator);
  // // gives not delcared error
}
